    ...
    <div class="typecho-login">
        ...
        <form action="<?php $options->registerAction(); ?>" method="post" name="register" role="form">
            <p>
                ...
                <input type="text" id="name" name="name" placeholder="<?php _e('利用者ID'); ?>" value="<?php echo $rememberName; ?>" class="text-l w-100" autofocus />
            </p>
            <p>
            ...
            <p class="submit">
                <button type="submit" class="btn btn-l w-100 primary"><?php _e('在籍'); ?></button>
            </p>
        </form>
