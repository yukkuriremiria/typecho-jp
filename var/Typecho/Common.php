...
namespace {
     ...
     * I18n function
     *
     * @param string $string 翻訳が必要なテキスト
     * @param mixed ...$args パラメトリック
     *
     * @return string
     */
...
namespace Typecho {
    ...
    class Common
    {
         ...
         * @access public
         *
         * @param string|null $path トレール
         * @param string|null $prefix 接頭辞
         *
         * @return string
         */
         ...
         * 出力エラーページ
         *
         * @param \Throwable $exception エラーメッセージ
         */
...
EOF;
         ...
         * 使用方法:
         * <code>
         * $input = 'の一部を切り取ったものだ。htmlコピー<a href="#"';
         * echo Common::fixHtml($input);
         * //output: の一部を切り取ったものだ。htmlコピー
         * </code>
         *
         * @param string|null $string 修正と処理が必要なストリングス
         * @return string|null
         */
         ...
         * </code>
         *
         * @param string|null $html 処理される文字列
         * @param string|null $allowableTags ロストhtmlタブ
         * @return string
         */
         ...
         * @access public
         *
         * @param string|null $str 必要略称の生成な字符串
         * @param string|null $default デフォルトの略称
         * @param integer $maxLength 略名の最大長
         *
         * @return string
         */
         ...
         * そうしれいかんurlの不正な文字列
         *
         * @param string $url 濾過url
         *
         * @return string
         */
        public static function safeUrl($url)
        {
            //~ 向けられるlocationなxssろ過, 特殊な特性のため使用不可removeXSS関数
            //~ fix issue 66
        ...
        /**
         * 地面parse_urlな结果重新组合url
         *
         * @param array $params 解析后なパラメトリック
         *
         * @return string
         */
         ...
         * 扱うXSS跨站攻击なろ過関数
         *
         * @param string|null $val 処理される文字列
         * @return string
         */
         ...
         * 宽字符串截字関数
         *
         * @param string $str 必要截取な字符串
         * @param integer $start 开始截取な位置
         * @param integer $length 必要截取な长度
         * @param string $trim 截取后な截断标示符
         *
         * @return string
         */
         ...
         * @access public
         *
         * @param string|null $from ソース文字列
         * @param string|null $to ターゲット文字列
         *
         * @return boolean
         */
         ...
         * @access public
         *
         * @param string|null $string 必要hashな字符串
         * @param string|null $salt スクランブラー
         *
         * @return string
         */
         ...
         * @param boolean $specialChars 特殊文字の有無
         *
         * @return string
         */
